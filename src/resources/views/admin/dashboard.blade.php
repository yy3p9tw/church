            ...
            <div class="col-md-9 col-lg-8">
                <div class="card shadow-lg border-0">
                    ...
                    <div class="card-body d-flex flex-wrap justify-content-center gap-4 py-4">
                        <a href="{{ route('admin.staff.index') }}" class="dashboard-btn">
                            <div class="icon">👥</div>
                            <div>同工管理</div>
                        </a>
                        <a href="{{ route('admin.sliders.index') }}" class="dashboard-btn">
                            <div class="icon">🖼️</div>
                            <div>輪播管理</div>
                        </a>
                        <a href="{{ route('admin.sermons.index') }}" class="dashboard-btn">
                            <div class="icon">🎤</div>
                            <div>講道管理</div>
                        </a>
                        <a href="{{ route('admin.groups.index') }}" class="dashboard-btn">
                            <div class="icon">👨‍👩‍👧‍👦</div>
                            <div>小組管理</div>
                        </a>
                        <a href="{{ route('admin.news.index') }}" class="dashboard-btn">
                            <div class="icon">📰</div>
                            <div>消息管理</div>
                        </a>
                        <a href="{{ route('admin.events.index') }}" class="dashboard-btn">
                            <div class="icon">📅</div>
                            <div>活動管理</div>
                        </a>
                        <a href="{{ route('admin.bulletins.index') }}" class="dashboard-btn">
                            <div class="icon">📄</div>
                            <div>週報管理</div>
                        </a>
                    </div>
